...
import { Stethoscope, User, Lock, Mail, ChevronRight, Activity, ShieldAlert } from "lucide-react"
    ...
    <div className="min-h-screen w-full relative overflow-hidden bg-white selection:bg-[#00e5c3]/30">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          ...
          className="absolute top-20 -left-40 w-96 h-96 bg-[#00e5c3] rounded-full blur-[120px]"
        />
        <motion.div
          animate={{
            scale: [1, 1.3, 1],
          ...
          className="absolute bottom-20 -right-40 w-96 h-96 bg-[#00e5c3] rounded-full blur-[120px]"
        />
      </div>
      ...
      <div className="relative z-10 min-h-screen w-full flex items-center justify-center p-4 lg:p-8">
        <div className="w-full max-w-7xl grid lg:grid-cols-[1fr_550px] gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <div className="mt-12 p-6 border-l-4 border-[#00e5c3] bg-gray-50 max-w-md">
              <p className="text-[10px] font-black uppercase tracking-widest text-gray-400 mb-2">Demo Credentials</p>
              <div className="flex justify-between text-[11px] font-bold text-gray-900">
                <span>IDENTITY: doctor@protengine.ai</span>
                <span>KEY: demo1234</span>
              </div>
            </div>
          </motion.div>
            ...
            <div className="bg-white backdrop-blur-3xl border border-gray-200 rounded-2xl p-8 lg:p-10 shadow-2xl shadow-black/10">
              ...
              <div className="mb-8 flex justify-between items-start">
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Sign in to access your portal</p>
                </div>
              ...
              <div className="flex gap-3 mb-8">
                ...
                >
                  <div className="flex flex-col items-center gap-2">
                    <Stethoscope className={`w-5 h-5 ${activeTab === "doctor" ? "text-black" : "text-gray-400"}`} />
                    <p className={`font-black text-[10px] uppercase tracking-widest ${activeTab === "doctor" ? "text-black" : "text-gray-500"}`}>Clinical Lead</p>
                  </div>
                </button>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-2 group">
                  <Label htmlFor="email" className="text-gray-500 font-black text-[9px] uppercase tracking-[0.2em] group-focus-within:text-[#00e5c3] transition-colors flex items-center gap-2">
                    <Mail className="w-3 h-3" /> Identity Signature
                  </Label>
                  <Input
                    id="email"
                    type="email"
                    defaultValue="doctor@protengine.ai"
                    placeholder="doctor@protengine.ai"
                    {...register("email", { required: "Identity signature required" })}
                  ...
                  />
                  {errors.email && (
                    <p className="text-[9px] font-bold text-red-500 uppercase tracking-wider">{errors.email.message}</p>
                  )}
                </div>

                <div className="space-y-2 group">
                  <Label htmlFor="password" className="text-gray-500 font-black text-[9px] uppercase tracking-[0.2em] group-focus-within:text-[#00e5c3] transition-colors flex items-center gap-2">
                  ...
                  />
                  {errors.password && (
                    <p className="text-[9px] font-bold text-red-500 uppercase tracking-wider">{errors.password.message}</p>
                  )}
                </div>

                <div className="flex items-center justify-between">
                  <label className="flex items-center gap-2 cursor-pointer group">
                    <input type="checkbox" className="w-4 h-4 rounded border-gray-300 text-[#00e5c3] focus:ring-[#00e5c3]" />
                    <span className="text-[10px] font-bold text-gray-500 uppercase tracking-wider group-hover:text-gray-900 transition-colors">Remember Session</span>
                  </label>
                  <a href="#" className="text-[10px] font-black text-[#00e5c3] uppercase tracking-wider hover:underline">
                    Reset Key?
                  </a>
                </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100">
                <div className="flex items-center justify-between text-[10px] font-bold text-gray-400 uppercase tracking-widest">
                  ...
                  <Link href="/" className="text-[#00e5c3] hover:underline">Return to Terminal</Link>
                </div>
              </div>
            </div>
          </motion.div>
