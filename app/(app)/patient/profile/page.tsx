...
export default function PatientProfilePage() {
  ...
  useEffect(() => {
    ...
    getMe()
      ...
      .catch(() => {
        // keep cookie user if getMe fails
      });
  }, []);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className={`${cardStyle} md:col-span-2 p-8`}>
          <div className="flex items-center justify-between mb-8">
            ...
            <span className="px-3 py-1 bg-emerald-100 text-emerald-700 rounded-lg text-[8px] font-black uppercase tracking-widest">
              Verified
            </span>
          </div>
          ...
          {user ? (
            <div className="divide-y divide-slate-100">
              {[
                ...
                {
                  label: "Bio-Link Status",
                  value: user.telegramHandle
                    ? `@${user.telegramHandle}`
                    : "Not established",
                },
              ].map((item) => (
                ...
                >
                  ...
                  <span className="text-sm font-black text-slate-900 group-hover:text-emerald-500 transition-colors uppercase tracking-tight">
                    {item.value}
                  </span>
                </div>
              ))}
        ...
        {/* Security Module */}
        <div
          className={`${cardStyle} p-8 flex flex-col justify-between bg-slate-900 text-white border-slate-800`}
        >
          ...
          <div className="space-y-4">
            <div className="p-4 bg-white/5 border border-white/10 rounded-2xl">
              ...
              <p className="text-[11px] font-medium text-slate-400 leading-relaxed uppercase">
                Your biometric data is encrypted at rest and in transit using
                hardware-level protocols.
              </p>
            </div>
        ...
        <div
          className={`${cardStyle} md:col-span-3 p-10 bg-slate-50 border border-slate-200/50 flex items-center gap-10`}
        >
          ...
          <div>
            ...
            <p className="text-sm font-medium text-slate-500 leading-relaxed max-w-3xl">
              To update your clinical information or medication history, please
              contact your healthcare provider. Records are immutable to ensure
              diagnostic integrity across the Healynx network.
            </p>
          </div>
